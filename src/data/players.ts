/**
 * 關鍵球員名單（61 人）— 2026 FIFA 世界盃
 *
 * 數據誠信聲明：
 * - 只填確定資料：姓名、國家隊、位置（大致分類）。號碼、年齡、球會無核實來源，一律 undefined。
 * - PlayerStats 只填 brief 有嘅數字：
 *   射手榜（準決賽後）：Mbappé 8、Messi 8 + 4 助攻、Haaland 7、Kane 6、Bellingham 6；
 *   Embolo 紅牌 1（M100）。其餘球員嘅單場入球記錄喺 matches.ts events/scorers，
 *   tournament 總數未核實，故此唔填，避免虛構。
 */
import type { Player } from '../types/football';

export const players: Player[] = [
  // --- 射手榜前列 ---
  { id: 'mbappe', nameZh: '麥巴比', nameEn: 'Kylian Mbappé', teamId: 'fra', position: 'FW', stats: { goals: 8 } },
  ...
  { id: 'kane', nameZh: '哈利·簡尼', nameEn: 'Harry Kane', teamId: 'eng', position: 'FW', stats: { goals: 6 } },
  { id: 'bellingham', nameZh: '比寧咸', nameEn: 'Jude Bellingham', teamId: 'eng', position: 'MF', stats: { goals: 6 } },
  ...
  { id: 'oyarzabal', nameZh: '奧耶沙巴', nameEn: 'Mikel Oyarzabal', teamId: 'esp', position: 'FW' },
  ...
  { id: 'e-fernandez', nameZh: '安素·費南迪斯', nameEn: 'Enzo Fernández', teamId: 'arg', position: 'MF' },
  ...
  { id: 'dembele', nameZh: '奧士文·迪比利', nameEn: 'Ousmane Dembélé', teamId: 'fra', position: 'FW' },
  ...
  { id: 'saka', nameZh: '布卡約·沙卡', nameEn: 'Bukayo Saka', teamId: 'eng', position: 'FW' },
  ...
  { id: 'quinones', nameZh: '昆奴尼斯', nameEn: 'Quiñones', teamId: 'mex', position: 'FW' },
  ...
  { id: 'sarr', nameZh: '沙亞', nameEn: 'Sarr', teamId: 'sen', position: 'FW' },
